...
public class EventListener : MonoBehaviour {
	...
	public void handleEvent(Vector3 position, Quaternion rotation, int direction){
		print (id);
		JSONObject json = new JSONObject ();

		switch (direction) {
		case 0:
			json.AddField ("action", "stop");
			break;
		case 1:
			json.AddField ("action", "goforward");
			break;
		case 2:
			json.AddField ("action", "goback");
			break;
		case 3:
			json.AddField ("action", "goleft");
			break;
		case 4:
			json.AddField ("action", "goright");
			break;
		}
